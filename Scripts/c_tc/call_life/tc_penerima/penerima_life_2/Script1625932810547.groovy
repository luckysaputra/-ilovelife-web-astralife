...
WebUI.setText(Path.INPUT_NAMA_PENERIMA_MANFAAT_1_LIFE, penerima_manfaat_2)
WebUI.click(Path.COMBOBOX_SIAPA_PENERIMA_MANFAAT_1_LIFE)
//WebUI.click(Path.SELECT_PENERIMA_MANFAAT_ANAK_LIFE)
String diaadalah2 = dia_adalah_2
TestObject pilih_diaadalah2 = new TestObject("diaadalah2")
pilih_diaadalah2.addProperty("xpath", ConditionType.EQUALS, diaadalah2)
WebUI.click(pilih_diaadalah2)
WebUI.click(Path.CLOSE_HELP, FailureHandling.OPTIONAL)
WebUI.click(Path.INPUT_BESAR_PRESENTASE_MANFAAT_LIFE)
WebUI.setText(Path.INPUT_BESAR_PRESENTASE_MANFAAT_LIFE, presentase_manfaat_2)
WebUI.uploadFile(Path.UPLOAD_FOTO_PROFIL_PENERIMA_MANFAAT_LIFE, profil_2, FailureHandling.OPTIONAL)

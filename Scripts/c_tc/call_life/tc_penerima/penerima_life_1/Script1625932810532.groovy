...
WebUI.setText(Path.INPUT_NAMA_PENERIMA_MANFAAT_1_LIFE, penerima_manfaat_1)
WebUI.click(Path.COMBOBOX_SIAPA_PENERIMA_MANFAAT_1_LIFE)
//WebUI.click(Path.SELECT_PENERIMA_MANFAAT_ISTRI_LIFE)
String diaadalah1 = dia_adalah_1
TestObject pilih_diaadalah1 = new TestObject("diaadalah1")
pilih_diaadalah1.addProperty("xpath", ConditionType.EQUALS, diaadalah1)
WebUI.click(pilih_diaadalah1)
WebUI.click(Path.CLOSE_HELP, FailureHandling.OPTIONAL)
WebUI.click(Path.INPUT_BESAR_PRESENTASE_MANFAAT_LIFE)
WebUI.setText(Path.INPUT_BESAR_PRESENTASE_MANFAAT_LIFE, presentase_manfaat_1)
WebUI.uploadFile(Path.UPLOAD_FOTO_PROFIL_PENERIMA_MANFAAT_LIFE, profil_1, FailureHandling.OPTIONAL)
